    ...
    var experiences = [
        {
            ...
            responsibilities: 'Leading initial client communications, fostering a strong relationship between the company and clients by coordinating meetings to discuss design elements and manufacturing processes. This began with our first collaboration with a famous London street artist, Slawn, whose previous projects include the Brit Awards, F1 liveries and official Nike collaboration shoes. Organisation of design reworks and marketing strategies was organised by myself.<br> All design prototyping was done via 3D printing, with the print farm managed by myself, optimising print parameters and material usage for small-batch production. This meant that we could make design iterations - prompted by the artist - and deliver the updated version to him within 2 days. A small run of celebrity-exclusive slides were also manufactured with personal details on the sole. <br> I managed marketing to extend the outreach of the product - print, promotions & digital. I directed and edited various promotional videos, and featured in various interviews for high-street footwear stores. Following this, we made an appearance in Esquire magazine for the slides.',
